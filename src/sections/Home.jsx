...
const socials = [
  { Icon: FaXTwitter, label: "X", href: "https://x.com/_pranav__sharma/" },
  { Icon: FaLinkedinIn, label: "LinkedIn", href: "https://www.linkedin.com/in/-pranav--sharma-/" },
  { Icon: FaInstagram, label: "Instagram", href: "https://www.instagram.com/pranav_sharma.official/" },
  { Icon: FaGithub, label: "GitHub", href: "https://github.com/Pranav-Sharma-Official" },
];
...
const Home = React.forwardRef((props, ref) => {
  const roles = useMemo(
    () => ["Software Developer", "Backend Developer", "Freelancer"],
    []
  );
          ...
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
            ...
            >
              <button
                ...
                bg-gradient-to-r from-[#1CD8D2] via-[#00bf8f] to-[#302b63]
                shadow-lg hover:scale-105 transition-all cursor-pointer border-none outline-none"
              >
                View My Work
              </button>
              <a
